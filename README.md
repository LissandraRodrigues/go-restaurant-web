 ...
 <hr/>
  ...
  <h1 align="center"> Go Restaurant Web </h1>

<p align="center">
   <img src="https://img.shields.io/badge/progress-100%25-brightgreen.svg" alt="PRs Welcome">
   <img src = "https://img.shields.io/github/issues/LissandraRodrigues/go-restaurant-web" />
   <img src = "https://img.shields.io/github/forks/LissandraRodrigues/go-restaurant-web" />
   <img src = "https://img.shields.io/github/stars/LissandraRodrigues/go-restaurant-web" />
...
Este projeto é resultado do meu nono desafio de código no <a href="https://rocketseat.com.br/gostack">bootcamp Go Stack da Rocketseat. </a> Nele fui desafiada a colocar em prática tudo que aprendi sobre React.js junto com TypeScript, praticando o conceito de CRUD (Create, Read, Update, Delete).
...
```bash
# Clone este projeto:
$ git clone https://github.com/LissandraRodrigues/go-restaurant-web
